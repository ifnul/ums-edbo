 ...
 * 2016-02-01T23:25:38.244+02:00
 * Generated source version: 3.0.1
 * 
 */
@WebServiceClient(name = "EDBOPerson", 
                  wsdlLocation = "/Users/ivanursul/git/ums/ums-edbo/ums-edbo-person/src/main/resources/wsdl/EDBOPerson.wsdl",
...
public class EDBOPerson extends Service {
    ...
    static {
        URL url = EDBOPerson.class.getResource("/Users/ivanursul/git/ums/ums-edbo/ums-edbo-person/src/main/resources/wsdl/EDBOPerson.wsdl");
        if (url == null) {
            url = EDBOPerson.class.getClassLoader().getResource("/Users/ivanursul/git/ums/ums-edbo/ums-edbo-person/src/main/resources/wsdl/EDBOPerson.wsdl");
        } 
        if (url == null) {
            java.util.logging.Logger.getLogger(EDBOPerson.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "/Users/ivanursul/git/ums/ums-edbo/ums-edbo-person/src/main/resources/wsdl/EDBOPerson.wsdl");
        }       
        WSDL_LOCATION = url;
    }
