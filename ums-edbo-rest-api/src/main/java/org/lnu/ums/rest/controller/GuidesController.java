...
public class GuidesController extends BaseController {
    ...
    public ArrayOfDUniversityFacultetsRequests2 getFacultiesRequests(@RequestParam(value = "SessionGUID", required = true) String sessionGUID,
                                                                     ...
                                                                     @RequestParam(value = "Id_PersonRequestStatusType1",required = false, defaultValue = "0") int idPersonRequestStatusType1,
                                                                     @RequestParam(value = "Id_PersonRequestStatusType2", required = false, defaultValue = "0") int idPersonRequestStatusType2,
                                                                     @RequestParam(value = "Id_PersonRequestStatusType3", required = false, defaultValue = "0") int idPersonRequestStatusType3,
                                                                     @RequestParam(value = "Id_PersonEducationForm", required = false, defaultValue = "0") int idPersonEducationForm,
                                                                     @RequestParam(value = "UniversityKode", required = false) String universityKode,
                                                                     @RequestParam(value = "Id_Qualification", required = false, defaultValue = "0") int idQualification,
                                                                     @RequestParam(value = "Filters", required = false) String filters) {
