 ...
 * 2015-07-07T16:13:36.135+03:00
 * Generated source version: 3.0.1
 * 
 */
@WebServiceClient(name = "EDBOGuides", 
                  wsdlLocation = "/home/ivanursul/Developing/git/ums/ums-edbo/ums-edbo-guides/src/main/resources/wsdl/EDBOGuides.wsdl",
...
public class EDBOGuides extends Service {
    ...
    static {
        URL url = EDBOGuides.class.getResource("/home/ivanursul/Developing/git/ums/ums-edbo/ums-edbo-guides/src/main/resources/wsdl/EDBOGuides.wsdl");
        if (url == null) {
            url = EDBOGuides.class.getClassLoader().getResource("/home/ivanursul/Developing/git/ums/ums-edbo/ums-edbo-guides/src/main/resources/wsdl/EDBOGuides.wsdl");
        } 
        if (url == null) {
            java.util.logging.Logger.getLogger(EDBOGuides.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "/home/ivanursul/Developing/git/ums/ums-edbo/ums-edbo-guides/src/main/resources/wsdl/EDBOGuides.wsdl");
        }       
        WSDL_LOCATION = url;
    }
