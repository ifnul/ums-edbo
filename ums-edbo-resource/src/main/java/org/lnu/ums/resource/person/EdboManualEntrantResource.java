...
public class EdboManualEntrantResource extends EdboResource implements Serializable {
    ...
    protected Integer resident;
    protected String birthday;
    protected Integer idPersonSex;
    protected String firstName;
    protected String middleName;
    protected String lastName;
    protected String koatuuCode;
    protected Integer idStreetType;
    ...
    protected Integer isForeinghEntrantDocumet;
    protected Integer isNotCheckAttestat;
    protected Integer idEntrantDocumnetType;
    ...
    protected Integer idEntrantDocumentsAwardType;
    protected Integer allowProcessedPersonalData;
    protected String posvidkaSeries;
    protected String posvidkaNumber;
    protected String posvidkaIssued;
    protected String posvidkaDate;
    ...
    public boolean equals(Object o) {
        ...
        if (idEntrantDocumnetType != null ? !idEntrantDocumnetType.equals(that.idEntrantDocumnetType) : that.idEntrantDocumnetType != null)
            return false;
        if (idLanguage != null ? !idLanguage.equals(that.idLanguage) : that.idLanguage != null) return false;
        if (idPerson != null ? !idPerson.equals(that.idPerson) : that.idPerson != null) return false;
        if (idPersonSex != null ? !idPersonSex.equals(that.idPersonSex) : that.idPersonSex != null) return false;
        if (idStreetType != null ? !idStreetType.equals(that.idStreetType) : that.idStreetType != null) return false;
        ...
        if (isNotCheckAttestat != null ? !isNotCheckAttestat.equals(that.isNotCheckAttestat) : that.isNotCheckAttestat != null)
            return false;
        if (koatuuCode != null ? !koatuuCode.equals(that.koatuuCode) : that.koatuuCode != null) return false;
        if (kodeSchool != null ? !kodeSchool.equals(that.kodeSchool) : that.kodeSchool != null) return false;
        ...
        if (posvidkaDate != null ? !posvidkaDate.equals(that.posvidkaDate) : that.posvidkaDate != null) return false;
        ...
        if (sessionGUID != null ? !sessionGUID.equals(that.sessionGUID) : that.sessionGUID != null) return false;
    ...
    public String toString() {
        return "EdboManualEntrantResource{" +
                "idEntrantDocumentsAwardType=" + idEntrantDocumentsAwardType +
                ", adress='" + adress + '\'' +
                ", allowProcessedPersonalData=" + allowProcessedPersonalData +
                ...
                ", entrantDocumnetUniversityKode='" + entrantDocumnetUniversityKode + '\'' +
                ", father='" + father + '\'' +
                ...
                ", icq='" + icq + '\'' +
                ", idCountry=" + idCountry +
                ", idEntrantDocumnetType=" + idEntrantDocumnetType +
                ", idLanguage=" + idLanguage +
                ", idPerson=" + idPerson +
                ", idPersonSex=" + idPersonSex +
                ", idStreetType=" + idStreetType +
                ", isForeinghEntrantDocumet=" + isForeinghEntrantDocumet +
                ...
                ", phone='" + phone + '\'' +
                ", postIndex='" + postIndex + '\'' +
                ", posvidkaDate='" + posvidkaDate + '\'' +
                ", posvidkaIssued='" + posvidkaIssued + '\'' +
                ", posvidkaNumber='" + posvidkaNumber + '\'' +
                ", posvidkaSeries='" + posvidkaSeries + '\'' +
                ", resident=" + resident +
