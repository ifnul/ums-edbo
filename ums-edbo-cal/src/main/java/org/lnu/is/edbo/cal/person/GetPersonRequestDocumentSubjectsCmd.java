...
public class GetPersonRequestDocumentSubjectsCmd extends AbstractGetEdboCommand<ArrayOfDPersonRequestDocumentSubjects> {
    ...
    public GetPersonRequestDocumentSubjectsCmd(String baseUrl, RestTemplate restTemplate) {
        super("GetPersonRequestDocumentSubjectsCmd", baseUrl, ArrayOfDPersonRequestDocumentSubjects.class, restTemplate);
    }
