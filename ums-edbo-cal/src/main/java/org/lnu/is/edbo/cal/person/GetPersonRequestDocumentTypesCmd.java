...
public class GetPersonRequestDocumentTypesCmd extends AbstractGetEdboCommand<ArrayOfDPersonDocumentTypes> {

    private String sessionGUID;
    private int idLanguage;
    private String actualDate;

    public GetPersonRequestDocumentTypesCmd(String baseUrl, RestTemplate restTemplate) {
